...
describe('Shopgate Image Builder > ', () => {
  ...
  describe('Variants > ', () => {
    ...
    it("Returns parent's images if no variant images are set", function() {
      const expectedImages = ['1.jpg', '2.jpg']
      tempProduct.images = [{ url_standard: '1.jpg' }, { url_standard: '2.jpg' }]
    ...
    it("Should display the variant's image only", function() {
      tempProduct.images = [{ url_standard: '1.jpg' }, { url_standard: '2.jpg' }]
    ...
    it("Should display the correct variant's image", function() {
      tempProduct.images = [{ url_standard: '1.jpg' }, { url_standard: '2.jpg' }]
      tempVariant.image_url = '3.jpg'
