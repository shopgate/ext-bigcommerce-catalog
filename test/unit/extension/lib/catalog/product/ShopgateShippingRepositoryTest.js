...
describe('ShopgateProductShippingRepositoryTest', () => {
  ...
  it('should provide free shipping when big commerce product has is_free_shipping set', () => {
    bigCommerceProductEntityFactoryStub.create.returns(new BigCommerceProductEntity({is_free_shipping: 1}, bigCommerceConfigurationStub))
  ...
  it('should provide free shipping when big commerce product has is_free_shipping set even though there is fixed_cost_shipping_price', () => {
    bigCommerceProductEntityFactoryStub.create.returns(new BigCommerceProductEntity({is_free_shipping: 1, fixed_cost_shipping_price: 5.59}, bigCommerceConfigurationStub))
    const subjectUnderTest = new ShopgateProductShippingRepository(clientStub, bigCommerceProductEntityFactoryStub)
    const expectedShipping = new ShopgateProductShipping(0, 'USD')
  ...
  it('should provide free shipping when there is no free shipping available but the shipping price is 0', () => {
    bigCommerceProductEntityFactoryStub.create.returns(new BigCommerceProductEntity({is_free_shipping: 0, fixed_cost_shipping_price: 0}, bigCommerceConfigurationStub))
    const subjectUnderTest = new ShopgateProductShippingRepository(clientStub, bigCommerceProductEntityFactoryStub)
    const expectedShipping = new ShopgateProductShipping(0, 'USD')
  ...
  it('should provide shipping price when there is no free shipping available', () => {
    bigCommerceProductEntityFactoryStub.create.returns(new BigCommerceProductEntity({is_free_shipping: 0, fixed_cost_shipping_price: 5.59}, bigCommerceConfigurationStub))
    const subjectUnderTest = new ShopgateProductShippingRepository(clientStub, bigCommerceProductEntityFactoryStub)
